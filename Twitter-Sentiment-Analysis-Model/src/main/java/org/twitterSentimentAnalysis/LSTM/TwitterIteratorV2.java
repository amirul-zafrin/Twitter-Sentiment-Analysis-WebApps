...
public class TwitterIteratorV2 implements DataSetIterator {
    ...
    public TwitterIteratorV2(String dataDir, WordVectors wordVectors, int batchSize, int truncateLength, boolean train) throws IOException {
